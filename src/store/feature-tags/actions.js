...
export const START_FETCH_FEATURE_TOGGLE_TAGS =
    "START_FETCH_FEATURE_TOGGLE_TAGS";
export const RECEIVE_FEATURE_TOGGLE_TAGS = "RECEIVE_FEATURE_TOGGLE_TAGS";
export const ERROR_FETCH_FEATURE_TOGGLE_TAGS =
    "ERROR_FETCH_FEATURE_TOGGLE_TAGS";
...
export function tagFeature(featureToggle, tag) {
    return dispatch => {
        ...
        return api
            ...
            .then(json =>
                dispatch({ type: TAG_FEATURE_TOGGLE, featureToggle, tag: json })
            )
...
export function untagFeature(featureToggle, tag) {
    return dispatch => {
        ...
        return api
            ...
            .then(() =>
                dispatch({ type: UNTAG_FEATURE_TOGGLE, featureToggle, tag })
            )
