...
export class AdminApi extends runtime.BaseAPI {
    ...
    /**
     */
    async getEnvironmentRaw(requestParameters: GetEnvironmentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FeatureEnvironmentInfoSchema>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FeatureEnvironmentInfoSchemaFromJSON(jsonValue));
    }

    /**
     */
    async getEnvironment(requestParameters: GetEnvironmentRequest, initOverrides?: RequestInit): Promise<FeatureEnvironmentInfoSchema> {
