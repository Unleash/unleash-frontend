...
export interface CreateApplication0Request {
    appName: string;
...
export class AdminApi extends runtime.BaseAPI {
    ...
    /**
     */
    async createApplicationRaw(requestParameters: CreateApplicationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupSchema>> {
        if (requestParameters.requestBody === null || requestParameters.requestBody === undefined) {
            throw new runtime.RequiredError('requestBody','Required parameter requestParameters.requestBody was null or undefined when calling createApplication.');
        }
    ...
    /**
     */
    async createApplication(requestParameters: CreateApplicationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupSchema> {
    ...
    /**
     */
    async createApplication_1Raw(requestParameters: CreateApplication0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.appName === null || requestParameters.appName === undefined) {
            throw new runtime.RequiredError('appName','Required parameter requestParameters.appName was null or undefined when calling createApplication_1.');
        }

        if (requestParameters.applicationSchema === null || requestParameters.applicationSchema === undefined) {
            throw new runtime.RequiredError('applicationSchema','Required parameter requestParameters.applicationSchema was null or undefined when calling createApplication_1.');
        }
    ...
    /**
     */
    async createApplication_1(requestParameters: CreateApplication0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.createApplication_1Raw(requestParameters, initOverrides);
    }
