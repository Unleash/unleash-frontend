...
// Returns undefined if the browser denies access to localStorage.
...
// Store an item from localStorage.
// Does nothing if the browser denies access to localStorage.
