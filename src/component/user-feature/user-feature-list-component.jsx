...
import UserFeature from './user-feature-list-item-component';
...
export default class UserFeatureListComponent extends React.PureComponent {
    static propTypes = {
    ...
    componentDidMount() {
        this.props.fetchFeatureToggles(this.props.userId);
    ...
    render() {
        const { features, toggleFeature, featureMetrics, settings, userId } = this.props;
