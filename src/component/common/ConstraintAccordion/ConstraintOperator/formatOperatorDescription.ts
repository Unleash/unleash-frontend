...
export const formatOperatorDescription = (operator: ConstraintSchemaOperatorEnum): string => {
...
const constraintOperatorDescriptions = {
    ...
    [ConstraintSchemaOperatorEnum.StrStartsWith]: 'is a string that starts with',
    ...
    [ConstraintSchemaOperatorEnum.NumGte]: 'is a number greater than or equal to',
