...
export default class ShowUserComponent extends React.Component {
    ...
    render() {
        ...
        const imageLocale = foundLocale
            ? `public/${foundLocale.image}.png`
            : `public/unknown-locale.png`;
        return (
            <div className={styles.showUserSettings}>
                <div
                    className={styles.showLocale}
                    id="select-locale"
                    style={{ cursor: "pointer" }}
                >
                    <img
                        src={imageLocale}
                        title={`Current locale is ${locale}`}
                        alt={locale}
                    />
                </div>
                <Menu
                    target="select-locale"
                    valign="bottom"
                    align="right"
                    ripple
                >
